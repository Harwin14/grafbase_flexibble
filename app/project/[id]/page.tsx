        ...
        <Modal>
            ...
            <section className='flexCenter flex-col mt-20'>
                ...
                <div className='flex flex-wrap mt-5 gap-5'>
                    <Link href={projectDetails?.githubUrl} target='_blank' rel="noreferrer" className='flexCenter gap-2 text-sm font-medium text-primary-purple'>
                    ...
                    <Image
                        ...
                        alt='dot'
                    />
                    <Link href={projectDetails?.liveSiteUrl} target='_blank' rel="noreferrer" className="flexCenter gap-2 text-sm font-medium text-primary-purple">
